  ...
  return (
    <Card className="w-full max-w-2xl shadow-xl border-primary/40 bg-card/80 backdrop-blur-sm">
      <CardHeader className="pb-4">
        ...
        <CardTitle className="text-3xl text-center font-heading text-primary">คำทำนายของคุณปรากฏแล้ว</CardTitle>
        <CardDescription className="text-center text-muted-foreground">
          ไม้เซียมซีได้บอกกล่าวแล้ว จงพิจารณาภูมิปัญญานี้
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="p-4 space-y-2 border rounded-lg border-primary/20 bg-background/50">
          <div className="flex items-center gap-2 text-accent">
            ...
            <h3 className="text-xl font-semibold font-heading">คำทำนาย</h3>
          </div>
        ...
        <div className="p-4 space-y-2 border rounded-lg border-primary/20 bg-background/50">
          <div className="flex items-center gap-2 text-accent">
            ...
            <h3 className="text-xl font-semibold font-heading">คำอธิบาย</h3>
          </div>
        ...
        <div className="p-4 space-y-2 border rounded-lg border-primary/20 bg-background/50">
           <div className="flex items-center gap-2 text-accent">
            ...
            <h3 className="text-xl font-semibold font-heading">คำแนะนำ</h3>
          </div>
